	...
	<div class="w-full max-w-180 flex flex-col">
		...
		<nav class="grid grid-cols-[1fr_auto_1fr] items-center pt-4.5 px-1 pb-5.5 gap-3">
			...
			<div class="flex gap-2 justify-self-end items-center">
				...
				{#if data.user}
					<button class="appearance-none cursor-pointer inline-flex items-center gap-1.5 bg-mint/12 border-[0.5px] border-mint/32 rounded-md px-3 h-8 text-mint text-[12px] font-medium font-mono tracking-[0.02em] transition-colors">
						{#if data.user.image}
